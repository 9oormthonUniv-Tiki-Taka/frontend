    ...
    <div className="min-h-screen bg-[#F8FBFF] px-4 py-12">
      <div className="max-w-5xl w-full mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-[#323639]">나의 수강 과목</h1>
...
// ✅ 강의 카드 컴포넌트 (hover 시 스타일 적용)
function HoverCard() {
  return (
    <div className="group flex justify-between items-center bg-white hover:bg-[#E9EEF2] transition-colors rounded-md py-4 px-5 text-sm text-gray-700 border border-gray-200 cursor-pointer">
      수업 이름 (강의실 이름)
