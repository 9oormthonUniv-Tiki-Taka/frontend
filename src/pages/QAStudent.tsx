...
import { ChevronDown, MessageSquare, Send, ThumbsUp, Heart } from 'lucide-react';
    ...
    <div className="bg-gray-50 min-h-screen flex flex-col">
      <div className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-sm text-gray-500 mb-8">
          <span>나의 수강 과목</span> &gt; <span className="font-semibold">과목 이름 (강의실 이동)</span>
        </div>

        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold">과목 이름</h1>
          <p className="text-gray-600 mt-2">내가 수강하는 과목의 질문 목록을 확인 할 수 있어요.</p>
        </div>

        <div className="max-w-2xl mx-auto mb-8">
            <div className="relative">
                <Input type="search" placeholder="검색어를 입력하세요." className="w-full pl-10 h-12 rounded-full" />
        ...
        <main className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-semibold text-lg">질문 목록</h2>
