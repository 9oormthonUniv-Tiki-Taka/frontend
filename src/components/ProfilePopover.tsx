    ...
    <Popover>
      <PopoverTrigger>
        <Avatar className="cursor-pointer">
          <AvatarFallback className="bg-[#d1d5db] text-xs text-white">DK</AvatarFallback>
        </Avatar>
      </PopoverTrigger>

      <PopoverContent className="w-64 p-4 space-y-3 bg-white shadow-md rounded-md border">
        <div>
